...
public final class Constants
{
    ...
    public static final double GRIP_ROTATE_DROP                       = 37.0; // FLOOR - 57
    public static final double GRIP_ROTATE_CHECK_ZONE                 = 87.0; // FLOOR - 7
    public static final double GRIP_ROTATE_CHECK_BRANCH               = 40.0; // FLOOR - 54
